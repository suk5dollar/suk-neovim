...
vim.keymap.set('n', '<leader>w', ':w<CR>', { desc = 'Write the current buffer' })
vim.keymap.set('n', '<leader>m', ':Explore<CR>', { desc = 'Open Netrw Menu in new buffer' })
-- ]]
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [A]ll files (inc hidden)' })
      -- ]]
